                ...
                children: [
                    {
                        ...
                        title: 'Welcome',
                        navLink:
                            'https://pixinvent.com/demo/MyManager-mail-template/mail-welcome.html',
                        externalLink: true
                    },
                    {
                        id: 'resetPassTemp',
                        title: 'Reset Password',
                        navLink:
                            'https://pixinvent.com/demo/MyManager-mail-template/mail-reset-password.html',
                        externalLink: true
                    },
                    {
                        id: 'verifyEmailTemp',
                        title: 'Verify Email',
                        navLink:
                            'https://pixinvent.com/demo/MyManager-mail-template/mail-verify-email.html',
                        externalLink: true
                    },
                    {
                        ...
                        navLink:
                            'https://pixinvent.com/demo/MyManager-mail-template/mail-deactivate-account.html',
                        externalLink: true
                    },
                    {
                        id: 'invoiceMailTemp',
                        title: 'Invoice',
                        navLink:
                            'https://pixinvent.com/demo/MyManager-mail-template/mail-invoice.html',
                        externalLink: true
                    },
                    {
                        ...
                        title: 'Promotional',
                        navLink:
                            'https://pixinvent.com/demo/MyManager-mail-template/mail-promotional.html',
                        externalLink: true
                    }
                ]
            },
