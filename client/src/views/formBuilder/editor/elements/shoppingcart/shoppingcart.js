let shoppingcart = {
  ...
  model: {
    defaults: {
      ...
      components: (props) => {
        return `
        <svg  class="shoppingcartDiv" data-gjs-selectable="false" xmlns="http://www.w3.org/2000/svg" version="1.1" width="100%" height="100%" viewBox="5.7 0 105.5 126.1" preserveAspectRatio="xMinYMax meet" data-hook="svg-icon-1">
          ...
          <text x="58.5" y="77" dy=".35em" text-anchor="middle" class="items-count" data-hook="items-count" style="fill: white;
