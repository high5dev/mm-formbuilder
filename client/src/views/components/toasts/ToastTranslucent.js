            ...
            <Col md="6" sm="12">
                <div className="p-3 bg-danger my-2 rounded">
                    <Toast>
                        <ToastHeader close={close}>MyManager</ToastHeader>
                        <ToastBody>
                            This is a toast on a danger background — check it
                            out!
                        </ToastBody>
                    </Toast>
                </div>
            ...
            <Col md="6" sm="12">
                <div className="p-3 bg-info my-2 rounded">
                    <Toast>
                        <ToastHeader close={close}>MyManager</ToastHeader>
                        <ToastBody>
                            This is a toast on an info background — check it
                            out!
                        </ToastBody>
                    </Toast>
                </div>
            ...
            <Col md="6" sm="12">
                <div className="p-3 bg-dark my-2 rounded">
                    <Toast>
                        <ToastHeader close={close}>MyManager</ToastHeader>
                        <ToastBody>
                            This is a toast on an dark background — check it
                            out!
                        </ToastBody>
                    </Toast>
                </div>
            ...
            <Col md="6" sm="12">
                ...
                >
                    <Toast>
                        <ToastHeader close={close}>MyManager</ToastHeader>
                        <ToastBody>
                            This is a toast on a transparent background — check
                            it out!
                        </ToastBody>
                    </Toast>
                </div>
