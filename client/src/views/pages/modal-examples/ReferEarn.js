                ...
                <ModalBody className="pb-5 px-sm-0">
                    <div className="px-sm-4 mx-50">
                        ...
                        <p className="text-center mb-5">
                            Invite your friend to MyManager, if they sign up,
                            you and
                            <br />
                    ...
                    <div className="px-sm-5 mx-50">
                        <h4 className="fw-bolder mt-5 mb-1">
                            Invite your friends
                        </h4>
                        <Row
                            tag="form"
                        ...
                        >
                            <Col lg="10">
                                <Label for="friendEmail" className="form-label">
                                    Enter your friend’s email address and invite
                                    them to join MyManager 😍
                                </Label>
                                <Input
                                    id="friendEmail"
                                    type="email"
                        ...
                        <h4 className="fw-bolder mt-4 mb-1">
                        ...
                        >
                            <Col lg="9">
                                ...
                                >
                                    You can also copy and send it or share it on
                                    your social media. 🥳
                                </Label>
                                <InputGroup className="input-group-merge">
                                    <Input
                                        type="url"
                                        id="referral-url"
                                        defaultValue="https://1.envato.market/MyManager_admin"
                                    />
                                    <InputGroupText
                                        tag="a"
                                        href="/"
