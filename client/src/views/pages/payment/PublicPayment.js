    ...
    <div>
      <Card>
        <Row className="">
          ...
          <Col sm={4} md={4} lg={4}>
            <div className="pt-2 mobile-responsive-invoice">
              <h3 className="mobile-responsive-invoice-text-h3">
                This invoice is powered by mymanager.com
              </h3>
            </div>
          </Col>
          <Col sm={4} md={4} lg={4}>
            <div className="pt-2 d-flex justify-content-end mobile-responsive-invoice-btn">
      ...
      {status === 'success' ? (
        ...
        <>
          <div className="text-center">
            ...
            <p>We sent an email to you for your order. Please review and pay on your invoice.</p>
          </div>
        </>
      )}
    </div>
