          ...
          dc.addType(elType.id, {
            model: oldModel.extend({
              initToolbar() {
                ...
                if(elType.id==='post-list-large' || elType.id==='post-card-large' || elType.id==='post-list-sidebar' || elType.id==='recent-post' || elType.id==='category-menu' || elType.id==='archive-menu'){
                  toolbar.unshift({
                    id: 'blog-management',
