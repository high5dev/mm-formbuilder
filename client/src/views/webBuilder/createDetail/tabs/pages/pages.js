import {Button, Card, CardBody, Col, Input, InputGroup, InputGroupText, Label, Row, TabContent, TabPane, UncontrolledTooltip} from "reactstrap";
...
import {cloneFormAction, deleteFormAction, deleteWebsiteAction, duplicateWebsiteAction, getPageAction, getWebsiteAction, updatePageNameAction} from "../../../store/action";
                                ...
                                <div className="tasks-area" style={{maxWidth: '100%', width: '100%'}}>
                                    <Fragment>
                                        <div className="m-1">
                                            ...
                                            <Card style={{height: '100%', borderRadius: 10, marginBottom: '1em', marginTop: '1em'}}
                                                  className={`shadow`}>
                                                <CardBody>
                                                    <iframe
                                                        // scrolling="no"
                                            ...
                                            <Card style={{height: '100%', borderRadius: 10, marginTop: '1em', marginBottom: '1em'}}
                                                ...
                                                <CardBody>
                                                    <div className="d-flex justify-content-between align-items-center">
                                                        <h5>Page Setting</h5>
                                                        <Button color="primary" className="ms" onClick={() => {handleSave()}}>
                                                            Save & Update
                                                        </Button>
                                                    </div>
                                                    <Row>
