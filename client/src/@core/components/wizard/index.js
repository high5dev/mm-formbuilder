...
import '../../scss/base/plugins/forms/form-wizard.scss';
...
const Wizard = forwardRef((props, ref) => {
  ...
  // ** Disable Double Next Buttons
  useEffect(() => {
    var buttons = document.querySelectorAll('.step-trigger');
  ...
  return (
    ...
    >
      ...
      <div className="bs-stepper-content" style={{ marginTop: 0 }}>
        {renderContent()}
      </div>
    </div>
  );
